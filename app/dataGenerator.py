...
def generatePredictData(teamId,opponentId,tossWon,batFirst):
    ...
    teamTossDecisionWinPercentage = getMatchWonPercentWhenTossWonForTeam(teamId)
    teamBatDecisionWonPercentage = getFirstBatWonPercentage(teamId)
    if(tossWon == teamId):
        teamTossWon = 1
    else:
        teamTossDecisionWinPercentage = 100 - teamTossDecisionWinPercentage
    ...
    data.loc[pos,"Toss_Decision_Win_Percentage"] = teamTossDecisionWinPercentage
